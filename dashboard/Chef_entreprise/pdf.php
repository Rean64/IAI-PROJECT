...
<bod>
  ...
  <div class="head">
    ...
    <img src="image/logo1.jpeg" alt="" width="70" height="70" style="margin-left: 10px;border-radius:35px">
    </a>
  ...
  <script type="text/javascript">
    function gendf() {
        ...
        doc.addHTML(document.getElementById('result')[2], function () {
...
<div align="center" style="margin-top: 10px;">
    <button id="saveaspdf" class="btn btn-info btn-lg" onclick="gendf()">Document</button>
</div>
